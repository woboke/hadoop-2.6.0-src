...
/**********************************************************************
 * ClientProtocol is used by user code via (经由／通过)
 * {@link org.apache.hadoop.hdfs.DistributedFileSystem} class to communicate (传达)
 * with the NameNode.  User code can manipulate(操作) the directory namespace(目录空间),
